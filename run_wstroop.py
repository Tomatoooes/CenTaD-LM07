...
logging_filename = os.path.join(Logging_Dir, timestamp + "_runwstroop.log")
...
if __name__ == "__main__":
    ...
    # text_color = (1, 1, 1)
    experiment = wstroopy.Stroop(para_trials, color_profile, constants.DIR_WORD)
    ...
    instructions = fileHandling.read_instructions_file(os.path.join(constants.DIR_MEDIA, constants.DIR_WORD,"INSTRUCTIONS"), settings['Language'], settings['Language'] + "End")
...
# =============================================================================
    # wait for keypressed
    utils.display_wait_keypressed(window, 'Ready to start word stroop test, \n\n Press anykey to continue....')
    ''' main experiment '''
    # High Arousal Video
    # experiment.display_instructions(window, instruction_stimuli, logFile, start_instruction='Test')#(self, window, instruction_stimuli, logFile, start_instruction=''):
    ha_trials = experiment.create_trials(os.path.join(constants.DIR_MEDIA, constants.DIR_WORD,"word_main.csv"))
    ...
    # Low Arousal Video
    la_trials = experiment.create_trials(os.path.join(constants.DIR_MEDIA, constants.DIR_WORD,"word_main.csv"))
