...
class AffectImage:
    def __init__(self, win, media_abs_path):
        ...
        self.imgNEU = glob.glob(os.path.join(media_abs_path, "NEU")+"\\*")
    ...
    def elicit_neutral(self, logger):
        ...
        self.display_image_sequences(self.imgNEU, logger)
    ...
    def display_image_sequences(self, img_list, logger):
        ...
        for x in img_list:
            logger.write(utils.get_current_time_micros() + f"\t Image {count+1} : {x}\n")
